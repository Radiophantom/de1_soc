...
create_clock -name pci_clk -period 30.000 [get_ports {PCI_CLK}]

set_input_delay -clock  { pci_clk } -min 0   [get_ports {PCI_FRAMEn PCI_AD[*] PCI_CBEn[*] PCI_PAR PCI_IDSEL PCI_IRDYn}] -add_delay
set_input_delay -clock  { pci_clk } -max 23  [get_ports {PCI_FRAMEn PCI_AD[*] PCI_CBEn[*] PCI_PAR PCI_IDSEL PCI_IRDYn}] -add_delay

set_output_delay -clock { pci_clk } -min -2  [get_ports {PCI_AD[*] PCI_PAR PCI_TRDYn PCI_STOPn PCI_DEVSELn}] -add_delay
set_output_delay -clock { pci_clk } -max 19  [get_ports {PCI_AD[*] PCI_PAR PCI_TRDYn PCI_STOPn PCI_DEVSELn}] -add_delay
